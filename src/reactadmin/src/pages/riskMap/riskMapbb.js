...
export default class RiskMap extends Component {
  constructor(props) {
    super(props);
    this.state = {
      headTitle: "admin",
            ...
            <div className="leftFilter">
              <div className="left-search">
                ...
                <Button
                  ...
                  onClick={this.keySearch.bind(this)}
                />
              </div>
                ...
                <div className="item-box">
                  {this.state.topData.map((item, i) => (
                    <div
                      className="item"
                      key={i}
                      onClick={this.showMoreModal.bind(this)}
                    >
                      <div className="left">
              ...
              <div className="infobox">
                ...
                <div className="right">
                  <div className="items">
                    ...
                    <div className="texts">
                      {this.state.modalInfo.enterpriseName}
                    </div>
                  </div>
                  <div className="items">
              ...
              <div className="infobox">
                ...
                <div className="other-right">
                  <div className="items">
                    ...
                    <div className="texts">
                      {this.state.modalInfo.updatetime}
                    </div>
                  </div>
                  <div className="items">
                    <div className="name">明厨亮灶数据:</div>
                    <div className="texts">
                      接入时间{this.state.modalInfo.updatetime}
                      <a href="#">查看视频</a>
                    </div>
                  </div>
                  <div className="items">
                  ...
                  <div className="items">
                    ...
                    <div className="texts">
                      数据最近更新日期{this.state.modalInfo.updatetime}
                    </div>
                  </div>
                  <div className="items">

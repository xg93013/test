        ...
        >
          <template slot-scope="scope">
            <div v-if="item.prop === 'taskStatus'" class="status">
              ...
              <span>
                <label class="blue"></label>待现场检查
              </span>
              <!-- <span>
                <label class="orange"></label>待跟踪指导
              </span>
              <label class="pass"></label>跟踪指导完成
              </span>
              -->
            </div>
            <div v-else-if="item.prop === 'enterpriseStatus'" class="status">
              <span>
                <label class="normal"></label>正常
              </span>
              <!-- <span>
                <label class="anomaly"></label>异常
              </span>
              <span>
                <label class="semi-shutdown">半停产</label>
              </span>
              <span>
                <label class="season-shutdown">季节性停产</label>
              </span>-->
            </div>
            <div v-else-if="item.prop === 'operation'">
              <div class="operation">
                ...
                <span @click="handleData(scope.$index, scope.row)">
                  <svg-icon iconClass="square"></svg-icon>数据填报
                </span>
                <span @click="handleDetail(scope.$index, scope.row)">
                  <svg-icon iconClass="detail"></svg-icon>任务详情
                </span>
                <span @click="handleExport(scope.$index, scope.row)">
                  <svg-icon iconClass="copy"></svg-icon>导出
                </span>
              </div>
            </div>

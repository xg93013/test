    ...
    <div class="content">
      ...
      <div class="mid">
        <div class="fl mid-left">
          ...
          <div class="m20">
            关键词搜索：
            <el-input v-model="search.keyWord" style="width:240px;"></el-input>
          </div>
        </div>
      ...
      <div class="bot">
        ...
        <el-table :data.sync="tableData" border style="margin-top: 20px;" height="250px">
          <el-table-column label="序号" prop="nums" width="100"></el-table-column>
          <el-table-column label="姓名" prop="name" sortable></el-table-column>
          <el-table-column label="工作单位" prop="enterpriseNum" sortable></el-table-column>
          <el-table-column label="执法资格证名称" prop="certificateName" sortable></el-table-column>
          <el-table-column label="执法资格编号" prop="certificateNum" sortable></el-table-column>
          <el-table-column label="所属专业" prop="certificateNum" width="350" sortable></el-table-column>

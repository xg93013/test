                    ...
                    <div className="filters">
                        <div className="leftFilter">
                            <div className="left-search">
                                <Input v-model="leftFilter.keyWork" placeholder="请输入要查询的企业名称" className="leftInput float-item" />
                                <Button type="primary" icon="search" width="40" className="leftBtn float-item" onClick={this.keySearch}></Button>
                            </div>
                                ...
                                <div className="item-box">
                                {
                                    this.state.leftList.map((item, i)=> (
                                        <div className="item" key={i}>
                                            ...
                                            <div className="right">
                                                <Progress type="circle" percent={item.percent}></Progress>

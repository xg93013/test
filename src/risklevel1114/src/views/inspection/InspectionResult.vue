<template>
  <div id="InspectionResult">
    ...
    />
    <AdvanceInspection
      v-show="currentNav==3&&enterpriseType == 'PRODUCTION'"
      :enterpriseName="enterpriseName"
      :enterpriseType="enterpriseType"
      :taskId="taskId"
      :inspectionType="inspectionType"
    ...
    />
    <InspectionHistory
      v-show="currentNav==(enterpriseType == 'PRODUCTION' ? 4: 3)"
    ...
    />
    <ImportantEvent
      v-show="currentNav==(enterpriseType == 'PRODUCTION' ? 5: 4)"
...
export default {
  ...
  created() {
    ...
    if (this.enterpriseType != "PRODUCTION") {
    ...
    handleResult(flag, changeType, page) {
      if (flag) {
        ...
        if (changeType == "nextPage") {
          let index = this.enterpriseType == "PRODUCTION" ? 5 : 4;

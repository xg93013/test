<template>
  <div id="DocResult">
    ...
    <div class="commonWidth">
      ...
      <DocStepone v-show="currentNav==0" :taskId="taskId" :enterpriseType="enterpriseType" :type="'view'"/>
      <DocSteptwo v-show="currentNav==1" :taskId="taskId" :enterpriseType="enterpriseType" :type="'view'"/>

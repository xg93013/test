  ...
  <div id="InspectionDetail">
    ...
    <div class="commonWidth bot">
      ...
      <div class="view-score">
        ...
        <span v-show="list&&viewType=='viewDynamic'">
          动态风险因素得分：
          <label class="aColor">{{score.totalScore-score.riskScore}}</label>
          分
        </span>
        ...
        <el-table :data="tableData" style="width: 100%;" border v-show="list">
          ...
          >
            <template slot-scope="scope">
              <div v-if="scope.column.property == 'riskScore'&&viewType == 'viewDynamic'">
                <span>{{scope.row.totalScore-scope.row.riskScore}}</span>
              </div>

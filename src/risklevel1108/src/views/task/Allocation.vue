...
export default {
  data() {
    ...
    return {
      ...
      // planNo: "",
      settingFinish: false,
      settingPeopleFlag: true,
      settingDateFlag: true,
      statusCount: {
        total: 0,
        setting: 0,
        notSetting: 0
  ...
  methods: {
    ...
    submit() {
      if (
        this.settingFinish &&
        this.settingPeopleFlag &&
        this.settingDateFlag
      ) {
    ...
    async submitData(type) {
      ...
      if (res) {
        if (res.data.code == 0) {
          ...
          if (type) {
            setTimeout(() => {
              this.$router.push("/TaskAllocation");
            }, 1000);
          }
        } else {

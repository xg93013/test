            ...
            <span class="item">
              ...
              <el-popover placement="bottom-start" trigger="hover" popper-class="score-pop">
                <div class="score-tips">
                  ...
                  <div class="big-title">企业管理体系得分比 = 符合、基本符和项总分值 / （总分 - 合理缺项总分）</div>
                  <div class="score-box">
                    <div class="left">
                      <div class="box-item">
                        <span>得分比：</span>
                      ...
                      <div class="box-item">
                        <span>总分：</span>
                        <el-input type="text" v-model="item.totalScore" class="inputs" disabled></el-input>&emsp;分
                      </div>
                      <div class="box-item">
                ...
                <span slot="reference" size="small" class="bColor">{{item.percent}}</span>
              </el-popover>%
            </span>
            <span class="item">
              总分(去除合理缺项)：
...
export default {
  ...
  methods: {
    ...
    getResult() {
      ...
      let total = this.scoreList[0].totalScore;

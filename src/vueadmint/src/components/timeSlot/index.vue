		...
		methods: {
			...
			async init() {
				...
				// if(res){
					...
					this.timeDatas = [...allDate.allDate];
					this.chooseMsg.year = allDate.allDate[0].years;
					for(let i=11;i>-1;i--){
						if(allDate.allDate[0].data.month[i].mark){
							this.chooseMsg.msg = allDate.allDate[0].data.month[i].date;
							this.num = i;
							this.numa = i;
							break;
						}

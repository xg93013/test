                    ...
                    interval: (index, value) => {
                        if (interval) {
                            ...
                            if (data.xData.length > 6) {
                                if (index % Math.ceil(data.xData.length / 10) === 0) {
                                    return value
                                }
                            } else {
                                return value
    ...
    horBar: (data, showAxis = true) => {
        ...
        let option = {
            tooltip: {
                ...
                formatter: (params) => {
                    return `${params[1].name}<br/>${toolTipName}：${params[1].value === undefined ? '暂无' : params[1].value}`
                },
                textStyle: {
                    color: '#fff',
                    fontSize: 12

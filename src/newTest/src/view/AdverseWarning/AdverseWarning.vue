        ...
        <div class="content">
            ...
            <div class="bot">
                ...
                <div class="box middle">
                    <div class="box-in">
                        <my-table :tableConfig="blendWarningTable" @exportClick="exportClick" ref="blendWarningTableRefs"/>
                    </div>
                </div>
                <div class="box right">
                    <div class="box-in">
                        <my-table :tableConfig="unionWarningTable" @exportClick="exportClick" ref="unionWarningTableRefs"/>
                    </div>
                </div>
            </div>
        </div>

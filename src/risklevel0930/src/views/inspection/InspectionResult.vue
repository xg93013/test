  ...
  <div id="InspectionResult">
    <div class="commonWidth" style="padding:10px;">
      <div class="top-title fl">
        ...
        <span>数据填报 - {{enterpriseName}} - 《2019年成都市食品生产经营主体食品安全风险》生产企业体系检查工作评分表</span>
      </div>
      <div class="fr">
    ...
    <EnterpriseStatus v-show="currentNav==0" />
    <SignTable v-show="currentNav==1" />
    <DynamicRisk v-show="currentNav==2" :enterpriseName="enterpriseName" />
    <AdvanceInspection v-show="currentNav==3" :enterpriseName="enterpriseName" />

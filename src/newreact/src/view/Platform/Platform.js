...
class Platform extends React.Component {
    ...
    render() {
        ...
        return (
            <div id="platform" className="con-box">
                <div className="list-box">
                    {this.state.datas.map((item, index) =>
                        <div key={index}>
                            <div>
                                <img src={require("./images/t" + index + ".png")} alt="" />
                                <span onClick={this.pageChange.bind(this, item.page)}>{item.name}</span>
                            </div>
                        </div>
                    )}
                </div>
                    ...
                    <div className="process-box">
                        ...
                        <div className="has-line">
                            <div className="box-line">
                                <Icon style={{ color: "#276AB0" }} type="caret-right" />
                            </div>
                            <div className="box-line-a has-circel">
                                <span></span>
                            </div>
                            <div className="box-img" onClick={this.openNewWindow.bind(this, urls[1])}>
                        ...
                        <div>
                            ...
                            <div className="box-img" onClick={this.openNewWindow.bind(this, urls[2])}>
                        ...
                        <div className="has-line">
                            ...
                            <div className="box-img" onClick={this.openNewWindow.bind(this, urls[3])}>
                        ...
                        <div>
                            ...
                            <div className="box-line-a"></div>
                            <div className="box-img" onClick={this.openNewWindow.bind(this, urls[4])}>
                        ...
                        <div>
                            ...
                            <div className="box-line-a"></div>
                            <div className="box-img" onClick={this.openNewWindow.bind(this, urls[5])}>

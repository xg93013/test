<template>
    <div class='szlDialog'>
        <!-- <div class="showMore" style="overflow:hidden;" @click='showDialog = true'>
            <img src="../images/more.png" style="margin:7px 8px 0px 8px;float:left;" />
            <span class="text" style="float:left;">查看更多</span>
        </div> -->
        <div class="showMore" @click='showDialog = true'>
            查看更多
        </div>
        <Modal class-name='slz_dialog' v-model="showDialog" :title="config.name + '列表'" :mask-closable="false" :width='config.modalWidth || 520'>
            <div class='szl-modal-table'>
                <Table :row-class-name="rowClassName" ref='table' height="440" :columns="columns" :data="datas" @on-row-click='rowClick'>
                </Table>

...
const baseUrl = process.env.NODE_ENV == 'development' ? '/api' : `http://${process.integration ? process.apiHost : '172.27.16.191:8080'}/api`;
...
let mockHttp;
mockHttp = require('@/util/fakeRegions.js');

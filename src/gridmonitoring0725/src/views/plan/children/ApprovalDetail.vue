              ...
              <el-form-item label="计划类型" prop="planType">
                <template>
                  <div class="form-item">
                    ...
                    <el-input v-model="normalForm.planType" disabled></el-input>
                  </div>
                </template>
              </el-form-item>
              <el-form-item label="计划年份" prop="planYear">
                <template>
                  <div class="form-item">
                    ...
                    <el-input v-model="normalForm.planYear" disabled></el-input>
                  </div>
                </template>
              </el-form-item>
                ...
                <template>
                  <div class="form-item">
                    <!-- <el-autocomplete
                      ...
                      style="width:100%"
                    ></el-autocomplete>-->
                    <el-input v-model="normalForm.docNum" disabled></el-input>
                  </div>
                </template>
              </el-form-item>
              <el-form-item label="执行开始日期" prop="startDate">
                <template>
                  <div class="form-item">
                    ...
                    <el-input v-model="normalForm.startDate" disabled></el-input>
                  </div>
                </template>
              </el-form-item>
              <el-form-item label="执行结束日期" prop="endDate">
                <template>
                  <div class="form-item">
                    ...
                    <el-input v-model="normalForm.endDate" disabled></el-input>
                  </div>
                </template>
              </el-form-item>
            </div>
              ...
              <el-form-item label="管理单位" label-width="120px" prop="manUnit">
                <template>
                  <div class="form-item">
                    ...
                    <el-input v-model="normalForm.manUnit" disabled></el-input>
                  </div>
                </template>
              </el-form-item>
              <el-form-item label="组织实施单位" label-width="120px" prop="orgUnit">
                <template>
                  <div class="form-item">
                    ...
                    <el-input v-model="normalForm.orgUnit" disabled></el-input>
                  </div>
                </template>
              </el-form-item>
                ...
                <el-form-item label="业态：" prop="busniess">
                  <template>
                    <div class="form-item">
                      ...
                      <el-input v-model="normalForm.busniess" disabled></el-input>
                    </div>
                  </template>
                </el-form-item>
                <el-form-item label="大类：" prop="kinds">
                  <template>
                    <div class="form-item">
                      ...
                      <el-input v-model="normalForm.kinds" disabled></el-input>
                    </div>
                  </template>
                </el-form-item>
              </div>
                ...
                <el-form-item label="牵头单位：" prop="topUnit">
                  <template>
                    <div class="form-item">
                      ...
                      <el-input v-model="normalForm.topUnit" disabled></el-input>
                    </div>
                  </template>
                </el-form-item>
              </div>
          ...
          <div class="list">
            ...
            <div class="list-table" ref="tableRefs">
              <el-table :data="tableData" border :span-method="objectSpanMethod">
                <el-table-column label="牵头单位" prop="topUnit"></el-table-column>

<template>
  <div id="TrackingResult">
    ...
    <div class="commonWidth first" :class="{'last':disabled}">
      <el-form label-width="170px" :model="form" ref="formRefs" class="clearBoth" :rules="formRules">
        ...
        <div class="tab-item">
          ...
          <div class="result-form">
            ...
            <el-form-item :label="type === 'rectification' || type === 'rectificationView' ?'整改复查时间：':'跟踪验证时间：'" prop="trackingDate">
              <el-date-picker
                type="date"
      ...
      <div style="width:100%;margin-bottom:20px;">
        <div style="width:100%;height:30px;line-height:30px;color:#909399;position:relative;"><span style="position:absolute;left:50%;transform: translateX(-50%);">整改复查意见建议</span></div>
        <div style="width:100%;">
          <el-input
            type="textarea"
            :maxlength="300"

...
export default {
  ...
  methods: {
    async getDefaultData() {
      let allplan = await http.get(PLAN, { planType: 'CATERING_BUSINESS' });
      if (allplan) {
    ...
    getTotalCount(item) {
      ...
      this.statusCount.allNum = item.verified + item.unverified;console.log(item);

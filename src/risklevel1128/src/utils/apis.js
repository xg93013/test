...
export default {
  ...
  PLAN_TASK: '/plan/task/all/list', //  {planNo}/{enterpriseId} 配置计划相关的检查任务  {planNo}/{pageNo}/{pageSize}根据获取计划编号获取相关的任务列表
  PLAN_TASK_ADD: '/plan/task',
  ...
  TASKS_ALL: '/tasks/all', // （计划概览）通过筛选条件获取任务列表
  ...
  EXPORT_TEMPLATE: 'template/download',
  EXPORT_ALL: 'export/all', // 数据查询导出
 ...
 */
  ...
  TEMPLATES: '/templates',
  TEMPLATE: '/template',
  TEMPLATES_M: '/templates_m',
  TEMPLATE_TYPE: '/template/types',
  TEMPLATE_E_TYPE: '/template/etypes',
  TEMPLATE_UPLOAD: '/template/upload',
  TEMPLATE_FILENAME: '/template/fileNames',
  TEMPLATE_DOWNLOAD: '/template/download',
  ACCOUNTS: '/common', // /SPOT_RECORD_GFP/accounts不同类型账户
  COMMON: '/common' // /common/CATERING_BUSINESS/food/bussiness 食品餐饮类别
}

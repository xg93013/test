<template>
  <div id="MatchDetail">
    ...
    <div class="commonWidth">
      ...
      <el-form label-width="200px" :model="form" :show-message="false">
        ...
        <div class="match-item">
          ...
          <el-form-item label="食品生产许可证食品类别：" prop="productCategory">
            <el-input
              ...
              disabled
              :class="{'emptyNo':form.productCategory==''&&matchType=='view'}"
              v-show="form.productCategory==''"
            ></el-input>
            <!-- <el-select v-model="foodTotal" style="width:90%;">
              <el-option
            ...
            <SelectTree :data="originTree" style="width:90%;" v-show="form.productCategory!=''"></SelectTree>
          </el-form-item>
    ...
    <div class="commonWidth" :class="{'bot':matchType=='view'}">
      <div class="match-title">
        <svg-icon iconClass="tips"></svg-icon>
        ...
        <span>
          ...
          <el-popover placement="bottom" trigger="hover" popper-class="score-pop">
            <div class="score-tips">
              ...
              <div class="big-title">企业静态态风险因素得分 = 某个产品最高品种细类的静态风险得分</div>
              <div class="score-box">
                <p style="line-height:30px;">示例：</p>
                <el-table :data="demoData" border>
                  <el-table-column label="序号" prop="nums" width="100" align="center"></el-table-column>
                  <el-table-column
                    label="食品生产许可证食品类别"
                    prop="foodLicenseCategory"
                    width="130"
                    align="center"
                  ></el-table-column>
                  <el-table-column label="食品、食品添加剂类别" prop="category" width="130" align="center"></el-table-column>
                  <el-table-column label="类别编号" prop="classNo" width="70" align="center"></el-table-column>
                  ...
                  <el-table-column label="食品风险等级" prop="riskLevel" width="120" align="center"></el-table-column>
                  <el-table-column label="分值（S）" prop="score" width="70" align="center"></el-table-column>
                </el-table>
                <div class="static-box">
                  <div class="left">
                    <p>说明：</p>
                    <p>1. 企业静态风险因素得分使用产品中得分最高的项目</p>
                    <p>2. 同时，参考分级原则划分食品静态风险等级：</p>
                  </div>
                  <div class="right">
                    <!-- II III IV V -->
                    <div class="item">
                      I级：
                      <span>0 &lt; 得分 &le; 15</span>
                    </div>
                    <div class="item">
                      III级：
                      <span>20 &lt; 得分 &le; 25</span>
                    </div>
                    <div class="item">
                      II级：
                      <span>15 &lt; 得分 &le; 20</span>
                    </div>
                    <div class="item">
                      IV级：
                      <span>25 &lt; 得分 &le; 40</span>
                    </div>
                    <div class="item">
                      V级：
                      <span>40 &lt; 得分</span>
            ...
            <span
              ...
              size="small"
              class="bColor"
            >{{score.score == '' ? '-':score.score}}</span>
          </el-popover>分&emsp;
          食品静态风险等级：
          <label class="cColor">{{score.level == '' ? '-':score.level}}</label>
        </span>
      </div>
      <el-table :data="tableData" border style="margin-top: 20px;">
        ...
        <el-table-column label="分值（S）" prop="score" width="120" align="center">
          <template slot-scope="scope">
            ...
            <div v-else-if="matchType=='manual'">
              <span
                ...
                style="cursor:pointer;color:#0079fe;"
              >请点击选择</span>
...
export default {
      ...
      demoData: [
        {
          nums: "1",
          category: "粮食加工品",
          foodLicenseCategory: "大米",
          classNo: "0102",
          className: "大米(大米、糙米、其他)",
          detail: "大米(大米、糙米、其他)",
          riskLevel: "低（Ⅰ）",
          score: 13.5
        }
  ...
  methods: {
    ...
    getRadioTree(row) {
      ...
      this.currentRow.className = row.label;
    ...
    async submitData(type) {
      ...
      for (let i = 0; i < this.tableData.length; i++) {
        data.push({
          ...
          foodLicenseCategory: this.tableData[i].foodLicenseCategory,
...
<style lang="scss">
.emptyNo.is-disabled .el-input__inner {

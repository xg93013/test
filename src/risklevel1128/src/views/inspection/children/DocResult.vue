<template>
  <div id="DocResult">
    ...
    <div v-if="type==='view'||!isFirst" class="commonWidth" style="padding:10px;">
      <div class="top-title fl">
        <svg-icon iconClass="tips"></svg-icon>
        <span v-if="type==='view'">审批结果</span>
        <span v-else>上次审批结果</span>
      </div>
  ...
  methods: {
    async getDefaultData() {
      ...
      if (res && res.data && res.data.code === 0) {
        ...
        debugger
        if (this.type === "view" && data.type === "APPROVEFAILED") {

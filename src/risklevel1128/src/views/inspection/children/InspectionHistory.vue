<template>
  <div id="InspectionHistory">
    <div class="commonWidth first">
      ...
      <div class="production-title" v-show="enterpriseType=='CATERING_BUSINESS'">动态风险因素问题列表</div>
      <el-table
        :data="tableData"
      ...
      >
        ...
        <el-table-column
          ...
          width="60"
          label="序号"
          v-if="enterpriseType=='CATERING_BUSINESS'"
        ></el-table-column>
        <el-table-column
          :prop="item.prop"
          :label="item.label"
        ...
        <div class="check-form">
          <div class="check-item">
            ...
            <el-form-item label="现场检查日期：" prop="dateTime">
              <el-input disabled v-model="inputForm.dateTime"></el-input>
              <!-- <el-date-picker
                type="date"
                placeholder="请选择日期"
  ...
  methods: {
    ...
    async getDefaultData() {
      ...
      if (recordList) {
        ...
        this.inputForm.dateTime = this.form.checkDate;

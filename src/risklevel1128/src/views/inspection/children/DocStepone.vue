    ...
    <div class="table-box">
      <div class="ent-info">
        ...
        <div class="mid">
          ...
          <div class="item">营业执照编号或信用编号</div>
          <div class="item">联系人及联系方式</div>

          <div v-if="enterpriseType=='FOOD_PRODUCTION'" class="item">食品生产许可证食品类别明细</div>
          <div v-else class="item">食品经营许可证经营范围</div>
  ...
  export default {
    ...
    methods: {
      ...
      setPreviewData(preview, data) {
        ...
        data.originData.suggest = preview.suggest
        ...
        data.originData.remarks = preview.remark
      ...
      save(){
        this.originData.remarks=this.form.remarks
        this.originData.suggest=this.form.suggest
      }
    },
    components: {
      SelectTree,

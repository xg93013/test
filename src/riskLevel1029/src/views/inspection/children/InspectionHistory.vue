        ...
        <div class="check-form">
          <div class="check-item">
            ...
            <el-form-item label="检查组员签名：" prop="personName">
              ...
              <!-- <el-select v-model="inputForm.personName" placeholder="检查组员签名：" style="width:100%;">
                <el-option
                  v-for="(itema ,indexa) in allPersonList"
                  :key="indexa+'personName'"
                  :label="itema.label"
                  @click.native="changePerson('personName', itema)"
                  :value="itema.label"
                ></el-option>
              </el-select>-->
            </el-form-item>
            <el-form-item label="监管部门检查人员签名：" prop="checkPerson">
              ...
              <!-- <el-select
                ...
                placeholder="监管部门检查人员签名"
                style="width:100%;"
              >
                <el-option
                  v-for="(itema ,indexa) in allPersonList"
                  :key="indexa+'checkPerson'"
                  :label="itema.label"
                  @click.native="changePerson('checkPerson', itema)"
                  :value="itema.label"
                ></el-option>
              </el-select>-->
            </el-form-item>
          ...
          <div class="check-item">
            <el-form-item label="企业负责人意见：" prop="entResult">
              ...
              <el-select v-model="inputForm.entResult">
                <el-option label="同意" :value="true">同意</el-option>
                <el-option label="不同意" :value="false">不同意</el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="企业负责人签名：" prop="entName">
              <el-input v-model="inputForm.entName"></el-input>
              <!-- <el-select v-model="inputForm.entName" placeholder="企业负责人签名" style="width:100%;">
                <el-option
                  v-for="(item ,index) in allPersonList"
                  :key="index+'entName'"
                  :label="item.label"
                  @click.native="changePerson('entName', item)"
                  :value="item.label"
                ></el-option>
              </el-select>-->
            </el-form-item>

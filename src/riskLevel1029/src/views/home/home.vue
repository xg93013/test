...
const { PERMISSIONS, USERINFO } = apis;
...
export default {
  ...
  created() {
    ...
    // this.$router.push(this.headerNav[this.headerIndex].children[0].children[0].path);
    // setTimeout(() => {
  ...
  computed: {
    // ...mapGetters(["loading"]),
    // leftNav() {
    //   if (this.headerNav[this.headerIndex].children) {
    //     return this.headerNav[this.headerIndex].children;
    //   }
    // }
  },
  methods: {
